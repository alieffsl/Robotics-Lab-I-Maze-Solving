...
WallFollowMode currentMode = RIGHT_WALL_FOLLOW; // Start with left wall following
...
void leftWallFollowing()
{
  ...
  if (isTimeToSwitchMode(110800)) {
    motorDelay(0, 0, 1500000);
    buzzer(1, 1000, 50);
    motorDelay(100, 60, 400);
